...
def insert_data(time, ph, temp, lux):
    ...
    sql = """INSERT INTO cabrini_tank_2018 VALUES(%s,%s,%s,%s) RETURNING id;"""
    sqlAWS = """INSERT INTO aquarium_data VALUES(%s,%s,%s,%s) RETURNING id;"""
    ...
    try:
        ...
        curAWS.execute(sqlAWS, ('DEFAULT', time, ph, temp, lux))
